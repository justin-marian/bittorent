...
function test1 {
	...
	cp tests/test1/* .
	correct=0
	run_timeout "mpirun --oversubscribe -np 4 ./bittorent"
...
function test2 {
	...
	cp tests/test2/* .
	correct=0
	run_timeout "mpirun --oversubscribe -np 6 ./bittorent"
...
function test3 {
	...
	cp tests/test3/* .
	correct=0
	run_timeout "mpirun --oversubscribe -np 5 ./bittorent"
...
function test4 {
	...
	cp tests/test4/* .
	correct=0
	run_timeout "mpirun --oversubscribe -np 7 ./bittorent"
	compare_files client3_file1 out1.txt
